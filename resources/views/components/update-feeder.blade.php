    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <input class="d-none" id="updateIdCustomer">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                <button id="update-modal-close-customer" class="btn bg-gradient-primary" data-bs-dismiss="modal" aria-label="Close">Close</button>
                <button onclick="Update()" id="update-btn-customer" class="btn bg-gradient-success" >Update</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    async function FillUpdateForm(id){
        console.log(id)
        document.getElementById('updateIdCustomer').value = id;
    ...
    async function Update(){
        ...
        let updateID = document.getElementById('updateIdCustomer').value;
        ...
        if (customerName.length === 0) {
            ...
            document.getElementById('update-modal-close-customer').click();
            ...
            if(res.status===200 && res.data===1){
                ...
                successToast('Updated completed');

                document.getElementById("update-form-customer").reset();
